...
flip_Forest_2020 <- flip(Forest_2020, direction = "v")
plot(flip_Forest_2020)
...
raster::writeRaster(final_Forest_2020, "./results/SSP4_RCP60/2020_SSP4_RCP60_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
...
flip_Forest_2030 <-flip(Forest_2030, direction = "v")
#plot(flip_Forest_2030)
...
final_Forest_2030 <- t(flip(f_Forest_2030, direction = "y"))
plot(final_Forest_2030) 


## Save raster in results folder

raster::writeRaster(final_Forest_2030, "./results/SSP4_RCP60/2030_SSP4_RCP60_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
...
flip_Forest_2050 <- flip(Forest_2050, direction = "v")
#plot(flip_Forest_2050)
...
raster::writeRaster(final_Forest_2050, "./results/SSP4_RCP60/2050_SSP4_RCP60_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
