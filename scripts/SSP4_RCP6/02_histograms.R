...
F_2020 <- raster("./data/GCAM/Forest_classes/SSP4_RCP6/2020/Forest_2020_1.tif")
...
writeRaster(Forest_2020, "./results/SSP4_RCP6_Forest_2020.tif")
...
tiff(file="SSP4_RCP6_2020_Histogram.tiff",
...
F_2030 <- raster("./data/GCAM/Forest_classes/SSP4_RCP6/2030/Forest_2030_1.tif")
...
writeRaster(Forest_2030, "./results/SSP4_RCP6_Forest_2030.tif")
...
tiff(file="SSP4_RCP6_2030_Histogram.tiff",
     width=9, height=7, units="in", res=150)
...
F_2050 <- raster("./data/GCAM/Forest_classes/SSP4_RCP6/2050/Forest_2050_1.tif")
...
writeRaster(Forest_2050, "./results/SSP4_RCP6_Forest_2050.tif")
...
tiff(file="SSP4_RCP6_2050_Histogram.tiff",
     width=9, height=7, units="in", res=150)
