...
F_2020 <- raster("./results/SSP5_RCP85/2020_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
...
tiff(file="2020_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized_Hist.tiff",
     width=9, height=7, units="in", res=150)
ggplot(ahist, aes(x = breaks, y = counts, fill = breaks)) + ## Note the new aes fill here
  geom_bar(stat = "identity",alpha = 0.8)+
  xlab("2020 SSP5 RCP85 Forested Land")+ ylab("Number of Grids")+
...
F_2030 <- raster("./results/SSP5_RCP85/2030_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
...
tiff(file="2030_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized_Hist.tiff",
     width=9, height=7, units="in", res=150)
ggplot(bhist, aes(x = breaks, y = counts, fill = breaks)) + ## Note the new aes fill here
  geom_bar(stat = "identity",alpha = 0.8)+
  xlab("2030 SSP5 RCP85 Forested Land")+ ylab("Number of Grids")+
  #scale_x_continuous(breaks = seq(0,1,10),
  # labels = seq(0,1,10))+
  scale_fill_gradient(low="black", high="green")  
...
F_2050 <- raster("./results/SSP5_RCP85/2050_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized.tif")
...
tiff(file="2050_SSP5_RCP85_Forest_GCAM-Demeter_GCMsMean_Harmonized_Hist.tiff",
     width=9, height=7, units="in", res=150)
ggplot(chist, aes(x = breaks, y = counts, fill = breaks)) + ## Note the new aes fill here
  geom_bar(stat = "identity",alpha = 0.8)+
  xlab("2050 SSP5 RCP85 Forested Land")+ ylab("Number of Grids")+
  #scale_x_continuous(breaks = seq(0,1,10),
  # labels = seq(0,1,10))+
  scale_fill_gradient(low="black", high="green")  
